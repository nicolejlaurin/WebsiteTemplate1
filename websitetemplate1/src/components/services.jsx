...
<div className='service'>
  <div className='services'>
	...
	<div class="service-text">
		...
		<p>Traditional application of one eyelash extension applied to each natural lash. Provides a more defined look as if you have on the perfect mascara naturally. As they are individual, they will only be as full as your natural lashes.</p>
 </div>
</div>
...
<div class="service-split">
	...
	<div class="service-text">
		<h4>Hybrid Lashes 💞</h4>
		<p>Hybrid Lash extensions are the half way step between a classic set of eyelash extensions and a volume set. This is a mixture of both Classic and Volume lashes to provide the fluffy look of Volume and the definition and boldness of Classics.</p>
	</div>
</div>
